...
par(mfrow=c(2,2))
#par(mar = rep(2, 4))
plot(DateTime,electric_data$Global_active_power, xlab='',ylab='Global Active Power (kilowatt)', type = 'l')
plot(DateTime,electric_data$Voltage, xlab= 'datetime', ylab= 'Voltage', type = 'l')
plot(DateTime,electric_data$Sub_metering_1, xlab = '', ylab= 'Energy sub metering', type = 'l')
...
plot(DateTime, electric_data$Global_reactive_power, xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l')
# close device
dev.off()